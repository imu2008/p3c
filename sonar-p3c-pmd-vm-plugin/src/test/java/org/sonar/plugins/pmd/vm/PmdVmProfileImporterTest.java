...
import org.sonar.plugins.pmd.vm.xml.PmdRuleset;
...
public class PmdVmProfileImporterTest {
  PmdVmProfileImporter importer;
  ValidationMessages messages;

  @Before
  public void setUpImporter() {
    messages = ValidationMessages.create();
    importer = new PmdVmProfileImporter(createRuleFinder());
  }

  @Test
  public void should_import_pmd_ruleset() {
    Reader reader = read("/org/sonar/plugins/pmd/vm/simple.xml");
  ...
  public void should_import_simple_profile() {
    ...
    assertThat(profile.getActiveRuleByConfigKey("pmd-vm", "rulesets/java/coupling.xml/ExcessiveImports")).isNotNull();
    assertThat(profile.getActiveRuleByConfigKey("pmd-vm", "rulesets/java/design.xml/UseNotifyAllInsteadOfNotify")).isNotNull();
    assertThat(messages.hasErrors()).isFalse();
  }

  @Test
  public void should_import_profile_with_xpath_rule() {
    Reader reader = read("/org/sonar/plugins/pmd/vm/export_xpath_rules.xml");
  ...
  public void should_import_parameter() {
    ...
    RulesProfile profile = importer.importProfile(reader, messages);
    ActiveRule activeRule = profile.getActiveRuleByConfigKey("pmd-vm", "rulesets/java/coupling.xml/ExcessiveImports");
  ...
  public void should_import_priority() {
    ...
    ActiveRule activeRule = profile.getActiveRuleByConfigKey("pmd-vm", "rulesets/java/design.xml/UseNotifyAllInsteadOfNotify");
    assertThat(activeRule.getSeverity()).isSameAs(RulePriority.MINOR);

    activeRule = profile.getActiveRuleByConfigKey("pmd-vm", "rulesets/java/coupling.xml/CouplingBetweenObjects");
  ...
  public void should_import_pmd_configuration_with_unknown_nodes() {
    Reader reader = read("/org/sonar/plugins/pmd/vm/complex-with-unknown-nodes.xml");
  ...
  public void should_deal_with_unsupported_property() {
    ...
    RulesProfile profile = importer.importProfile(reader, messages);
    ActiveRule check = profile.getActiveRuleByConfigKey("pmd-vm", "rulesets/java/coupling.xml/CouplingBetweenObjects");
  ...
  public void should_warn_on_unknown_rule() {
    ...
    importer = new PmdVmProfileImporter(mock(RuleFinder.class));
    RulesProfile profile = importer.importProfile(reader, messages);
