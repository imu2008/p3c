...
public class PmdVmProfileExporter extends ProfileExporter {
  public PmdVmProfileExporter() {
  ...
  public void exportProfile(RulesProfile profile, Writer writer) {
    ...
    PmdRuleset tree = createPmdRuleset(PmdVmRulesDefinition.REPOSITORY_KEY, profile.getActiveRulesByRepository(PmdVmRulesDefinition.REPOSITORY_KEY), profileName);
