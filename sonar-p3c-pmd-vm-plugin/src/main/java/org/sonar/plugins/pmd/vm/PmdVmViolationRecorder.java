...
public class PmdVmViolationRecorder implements BatchExtension {

    private final FileSystem fs;
    private final RuleFinder ruleFinder;
    private final ResourcePerspectives perspectives;

    public PmdVmViolationRecorder(FileSystem fs, RuleFinder ruleFinder,
    ...
    public void saveViolation(RuleViolation pmdViolation) {
        ...
        IssueBuilder issueBuilder = issuable.newIssueBuilder().ruleKey(rule.ruleKey())
                .message(pmdViolation.getDescription()).line(pmdViolation.getBeginLine());
    ...
    private Rule findRuleFor(RuleViolation violation) {
        ...
        Rule rule = ruleFinder.findByKey(PmdVmRulesDefinition.REPOSITORY_KEY, ruleKey);
        return rule;
    }
